...
/*   Updated: 2024/10/30 16:01:59 by dlippelt         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <stdio.h>
//#include "/home/dlippelt/codam/main/ft_printf/ft_printf.h"
#include "/home/dlippelt/codam/evals/ft_printf/3/ft_printf.h"
...
static void	test_integers(void)
{
	...
	n1 = printf("1: Zero and precision 0 (right aligned): %i\n", 0);
	n2 = ft_printf("2: Zero and precision 0 (right aligned): %i\n", 0);
	printf("Return values: printf=%d, ft_printf=%d\n\n", n1, n2);
